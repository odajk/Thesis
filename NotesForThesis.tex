...
\textbf{Alt som står i denne delen er hentet fra MacLaurin og Adams. Må nok skrives om før det kan settes inn i oppgaven} åæøæåæ
...
For hver $n$ introduserer vi en binær hjelpevariablel $z_n \in {0,1}$, og en funksjon $B_n(\theta)$ som er strengt positiv og nedre begrenset av den $n$'te likelihooden : $0 < B_n(\theta)\leq L_n(\theta}$
...
\textbf{Skriv en bedre avslutning på setningen}.
